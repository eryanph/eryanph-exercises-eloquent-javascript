 ...
 * test function on the current loop value and stops if that returns false. Then it calls the body
 * function, giving it the current value. Finally, it calls the update function to create a new value
